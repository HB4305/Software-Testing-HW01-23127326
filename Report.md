...
|:---------------|:----------------------------------------------------------------|:------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:--------|
| TC-01          | Verify Cool Shot Mode activation and functionality              | Standard 220V outlet, switch at 'Cool' mode, 1 minute duration.                           | 1. Plug the device into a standard 220V outlet.<br>2. Slide the switch to the Cool mode position.<br>3. Keep it running for 1 minute and feel the exhaust air. | The fan rotates smoothly. The air discharged from the nozzle remains at room temperature without any heat generation.                                      |               |         |
| TC-02          | Verify Low Heat (Speed 1) functionality                         | Switch moved from 'Off' to 'Position 1'.                                                  | 1. Move the slide switch from 'Off' directly to Position 1.<br>2. Observe the air speed and temperature changes.                                               | The motor turns on instantly. The fan operates at low speed, emitting warm air steadily.                                                                   |               |         |
| TC-03          | Verify High Heat (Speed 2) functionality                        | Switch moved from 'Position 1' to 'Position 2'.                                           | 1. Move the slide switch from Position 1 to Position 2.<br>2. Monitor the changes in airflow and heat level.                                                   | The air speed increases noticeably compared to Position 1, and the air becomes hotter.                                                                     |               |         |
| TC-04          | Verify immediate cutoff on Switch Power Off                     | Switch moved from 'Position 2' to 'Off'.                                                  | 1. While running the dryer at High Heat (Position 2), slide the switch firmly back to 'Off'.                                                                   | The heating element and motor shut off immediately. No residual electrical hum or continuing operation occurs.                                             |               |         |
| TC-05          | Verify mechanical stability of the Folding Handle               | Handle unfolded to locked position, gentle shaking, handle folded back.                   | 1. Completely unfold the handle until it locks.<br>2. Shake the device gently to simulate usage.<br>3. Fold the handle back down against the main body.        | The handle locks securely in the open position with a distinct mechanical click and zero wobbling. It collapses cleanly without catching or binding.       |               |         |
| TC-06          | Verify structural security of the Concentrator Nozzle           | Attachment nozzle snapped onto barrel, 360° rotation, pulling force.                      | 1. Snap the attachment nozzle onto the barrel front.<br>2. Rotate it 360 degrees.<br>3. Pull firmly to detach it.                                              | The nozzle snaps on firmly, rotates smoothly without slipping off, and detaches cleanly under intended manual pull force.                                  |               |         |
| TC-07          | Verify Concentrator Nozzle retention under high thermal stress  | High Heat (Position 2) mode, nozzle attached, 5 continuous minutes duration.              | 1. Run the device at High Heat (Position 2) with the nozzle attached for 5 continuous minutes.<br>2. Observe if structural warping or looseness occurs.        | The clear plastic nozzle remains firmly attached to the barrel tip. It does not soften, deform, or fly off due to heat or air pressure.                    |               |         |
| TC-08          | Verify the integrity and function of the Hanging Loop           | Device suspended by integrated rubber loop on a wall hook, 24 hours duration.             | 1. Hang the dryer by the integrated rubber loop at the base of the handle onto a wall hook.<br>2. Leave it suspended for 24 hours.                             | The loop supports the full weight of the hair dryer (approx. 400g) without tearing, excessive stretching, or letting the unit fall.                        |               |         |
| TC-09          | Verify structural integrity of the power cord anti-kink sleeve  | Flexing power cord in multiple directions at the entrance point.                          | 1. Hold the handle firmly.<br>2. Flex the power cord at the entrance point in multiple directions to simulate natural handling.                                | The rubber strain relief boot protects the cord, prevents sharp bends at the interface, and ensures no inner copper conductors are exposed.                |               |         |
| TC-10          | Verify Air Inlet Grille protection barrier                      | High Heat mode, loose bundle of synthetic hair threads near rear honeycomb mesh.          | 1. Turn the dryer to High Heat mode.<br>2. Pass a loose bundle of synthetic hair threads near the rear honeycomb air intake mesh.                              | The dense honeycomb mesh safely prevents individual strands from being sucked inside the chamber or tangled into the internal fan blades.                  |               |         |
