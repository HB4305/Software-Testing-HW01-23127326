...
![Job1ScreenShot1](refs/job1-1.png)
![Job1ScreenShot2](refs/job1-2.png)
...
![Job2ScreenShot1](refs/job2-1.png)
![Job2ScreenShot2](refs/job2-2.png)
...
| TC-02          | Verify Low Heat (Speed 1) functionality                         | Switch moved from 'Off' to 'Position 1'.                                                  | 1. Move the slide switch from 'Off' directly to Position 1.<br>2. Observe the air speed and temperature changes.                                             | The motor turns on instantly. The fan operates at low speed, emitting warm air steadily.                                                                   | As Expected                                                                                             | Pass      |
| TC-03          | Verify High Heat (Speed 2) functionality                        | Switch moved from 'Position 1' to 'Position 2'.                                           | 1. Move the slide switch from Position 1 to Position 2.<br>2. Monitor the changes in airflow and heat level.                                                 | The air speed increases noticeably compared to Position 1, and the air becomes hotter.                                                                     | The air speed increased compared to Position 1, but the air temperature remained similar to Position 1. | Fail      |
| TC-04          | Verify immediate cutoff on Switch Power Off                     | Switch moved from 'Position 2' to 'Off'.                                                  | 1. While running the dryer at High Heat (Position 2), slide the switch firmly back to 'Off'.                                                                 | The heating element and motor shut off immediately. No residual electrical hum or continuing operation occurs.                                             | As Expected                                                                                             | Pass      |
| TC-05          | Verify mechanical stability of the Folding Handle               | Handle unfolded to locked position, gentle shaking, handle folded back.                   | 1. Completely unfold the handle until it locks.<br>2. Shake the device gently to simulate usage.<br>3. Fold the handle back down against the main body.      | The handle locks securely in the open position with a distinct mechanical click and zero wobbling. It collapses cleanly without catching or binding.       | As Expected                                                                                             | Pass      |
| TC-06          | Verify structural security of the Concentrator Nozzle           | Attachment nozzle snapped onto barrel, 360° rotation, pulling force.                      | 1. Snap the attachment nozzle onto the barrel front.<br>2. Rotate it 360 degrees.<br>3. Pull firmly to detach it.                                            | The nozzle snaps on firmly, rotates smoothly without slipping off, and detaches cleanly under intended manual pull force.                                  | As Expected                                                                                             | Pass      |
| TC-07          | Verify Concentrator Nozzle retention under high thermal stress  | High Heat (Position 2) mode, nozzle attached, 5 continuous minutes duration.              | 1. Run the device at High Heat (Position 2) with the nozzle attached for 5 continuous minutes.<br>2. Observe if structural warping or looseness occurs.      | The clear plastic nozzle remains firmly attached to the barrel tip. It does not soften, deform, or fly off due to heat or air pressure.                    | As Expected                                                                                             | Pass      |
| TC-08          | Verify the integrity and function of the Hanging Loop           | Device suspended by integrated rubber loop on a wall hook, 24 hours duration.             | 1. Hang the dryer by the integrated rubber loop at the base of the handle onto a wall hook.<br>2. Leave it suspended for 24 hours.                           | The loop supports the full weight of the hair dryer (approx. 400g) without tearing, excessive stretching, or letting the unit fall.                        | The hanging loop stretching after 24 hours of suspension.                                               | Fail      |
| TC-09          | Verify structural integrity of the power cord anti-kink sleeve  | Flexing power cord in multiple directions at the entrance point.                          | 1. Hold the handle firmly.<br>2. Flex the power cord at the entrance point in multiple directions to simulate natural handling.                              | The rubber strain relief boot protects the cord, prevents sharp bends at the interface, and ensures no inner copper conductors are exposed.                | The cord folded sharply at the housing entry point with minimal support from the strain relief boot.    | Fail      |
| TC-10          | Verify Air Inlet Grille protection barrier                      | High Heat mode, loose bundle of synthetic hair threads near rear honeycomb mesh.          | 1. Turn the dryer to High Heat mode.<br>2. Pass a loose bundle of synthetic hair threads near the rear honeycomb air intake mesh.                            | The dense honeycomb mesh safely prevents individual strands from being sucked inside the chamber or tangled into the internal fan blades.                  | Several hair strands passed through the honeycomb mesh and entered the air intake area.                 | Fail      |
| TC-11          | Verify Overheating Safety Cut-off (Rơ-le tự ngắt) activation    | High Heat mode, solid non-flammable barrier completely blocking rear air inlet mesh.      | 1. Turn the hair dryer to High Heat.<br>2. Completely block the rear air inlet mesh using a solid non-flammable barrier to intentionally induce overheating. | The internal thermal overload relay trips automatically, cutting off all power to the device to prevent fire or melting.                                   | As Expected                                                                                             | Pass      |
| TC-12          | Verify Overheating Safety Cut-off auto-reset capability         | Tripped unit, disconnected power for 10-15 minutes, re-plugged and switched on.           | 1. Allow the tripped unit from TC-11 to sit disconnected from power for 10-15 minutes until it cools completely.<br>2. Re-plug and switch it on.             | The internal thermal relay successfully resets itself, and the dryer returns to normal operation across all 3 switch modes.                                | As Expected                                                                                             | Pass      |
| TC-13          | Verify casing material thermal insulation (ABS plastic quality) | High Heat (Position 2) mode, 10 minutes continuous duration, hand gripping the casing.    | 1. Run the device continuously at High Heat (Position 2) for 10 minutes.<br>2. Grip the handle and touch the main outer casing.                              | The handle remains cool to the touch. The barrel surface gets warm but stays safe to handle without causing minor burns or emitting burning plastic odors. | The handle became noticeably hot after 10 minutes of operation, making it uncomfortable to hold.        | Fail      |
...
|:---------------|:----------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------|:-----------------------------------------------------------------------------------------------------------------------|
| TC-01          | Verify Cool Shot Mode activation and functionality              | The fan rotates smoothly. The air discharged from the nozzle remains at room temperature without any heat generation.                                      | Completed      | Working as expected. No issues observed.                                                                               |
| TC-02          | Verify Low Heat (Speed 1) functionality                         | The motor turns on instantly. The fan operates at low speed, emitting warm air steadily.                                                                   | Completed      | Working as expected. No issues observed.                                                                               |
| TC-03          | Verify High Heat (Speed 2) functionality                        | The air speed increases noticeably compared to Position 1, and the air becomes hotter.                                                                     | Completed      | Failed. Issue: The air speed increased compared to Position 1, but the air temperature remained similar to Position 1. |
| TC-04          | Verify immediate cutoff on Switch Power Off                     | The heating element and motor shut off immediately. No residual electrical hum or continuing operation occurs.                                             | Completed      | Working as expected. No issues observed.                                                                               |
| TC-05          | Verify mechanical stability of the Folding Handle               | The handle locks securely in the open position with a distinct mechanical click and zero wobbling. It collapses cleanly without catching or binding.       | Completed      | Working as expected. No issues observed.                                                                               |
| TC-06          | Verify structural security of the Concentrator Nozzle           | The nozzle snaps on firmly, rotates smoothly without slipping off, and detaches cleanly under intended manual pull force.                                  | Completed      | Working as expected. No issues observed.                                                                               |
| TC-07          | Verify Concentrator Nozzle retention under high thermal stress  | The clear plastic nozzle remains firmly attached to the barrel tip. It does not soften, deform, or fly off due to heat or air pressure.                    | Completed      | Working as expected. No issues observed.                                                                               |
| TC-08          | Verify the integrity and function of the Hanging Loop           | The loop supports the full weight of the hair dryer (approx. 400g) without tearing, excessive stretching, or letting the unit fall.                        | Completed      | Failed. Issue: The hanging loop stretching after 24 hours of suspension.                                               |
| TC-09          | Verify structural integrity of the power cord anti-kink sleeve  | The rubber strain relief boot protects the cord, prevents sharp bends at the interface, and ensures no inner copper conductors are exposed.                | Completed      | Failed. Issue: The cord folded sharply at the housing entry point with minimal support from the strain relief boot.    |
| TC-10          | Verify Air Inlet Grille protection barrier                      | The dense honeycomb mesh safely prevents individual strands from being sucked inside the chamber or tangled into the internal fan blades.                  | Completed      | Failed. Issue: Several hair strands passed through the honeycomb mesh and entered the air intake area.                 |
| TC-11          | Verify Overheating Safety Cut-off activation                    | The internal thermal overload relay trips automatically, cutting off all power to the device to prevent fire or melting.                                   | Completed      | Working as expected. No issues observed.                                                                               |
| TC-12          | Verify Overheating Safety Cut-off auto-reset capability         | The internal thermal relay successfully resets itself, and the dryer returns to normal operation across all 3 switch modes.                                | Completed      | Working as expected. No issues observed.                                                                               |
| TC-13          | Verify casing material thermal insulation (ABS plastic quality) | The handle remains cool to the touch. The barrel surface gets warm but stays safe to handle without causing minor burns or emitting burning plastic odors. | Completed      | Failed. Issue: The handle became noticeably hot after 10 minutes of operation, making it uncomfortable to hold.        |
...
**Result:** The device successfully produces heat, confirming the heating element is functional. However, the design's heat protection mechanism is inadequate.
**Expected vs. Actual:**
* **Expected:** The heating element should be securely fixed with ceramic or mica insulation and an internal protective net to prevent contact with the casing or external objects.
* **Actual:** The heating element is **not** fixed with ceramic or mica. It appears to be suspended by thin metal wires or simply inserted into a plastic bracket. When the device is heated, significant amounts of smoke are emitted from the nozzle and grille for several minutes, indicating burning plastic or residue.
**Reason for Failure:** The observed smoke confirms that plastic components near the heating element are melting or burning during operation. This structural failure poses a serious fire hazard and violates basic safety standards for electrical appliances.

#### 2. TC-08: Hanging Loop Structural Failure
**Objective:** Verify the structural integrity of the integrated rubber hanging loop.
**Result:** The loop stretches significantly after a short period of suspension, failing to maintain its original shape or support the device reliably.
**Expected vs. Actual:**
* **Expected:** The hanging loop should securely support the weight of the hair dryer (approximately 400g) without deformation, ensuring it hangs straight and stable from a wall hook.
* **Actual:** The rubber loop stretches noticeably after being suspended for just a few minutes. It fails to return to its original shape, indicating a lack of elasticity and structural strength. The device hangs crookedly, and the loop appears unlikely to safely support the dryer over long periods.
**Reason for Failure:** The rubber material used for the loop is too soft or thin. It lacks the tensile strength and elasticity required for its intended purpose, creating a potential safety hazard where the dryer could fall.

#### 3. TC-09: Power Cord Anti-Kink Sleeve Failure
**Objective:** Verify the integrity and protection provided by the anti-kink sleeve at the power cord entry point.
**Result:** The power cord bends sharply at the housing entry point, with minimal support from the strain relief sleeve.
**Expected vs. Actual:**
* **Expected:** The rubber strain relief boot should protect the cord from sharp bends, preventing damage to the internal conductors and ensuring long-term durability.
* **Actual:** The cord folds sharply at the point where it enters the housing. The anti-kink sleeve provides very little support, allowing the cord to bend at a nearly 90-degree angle.
**Reason for Failure:** The sleeve is too short or too rigid to properly support the cord. This sharp bend creates significant stress on the internal wires, which can lead to breakage over time and create a safety hazard.

#### 4. TC-10: Air Inlet Grille Protection Failure
**Objective:** Verify that the air inlet grille prevents foreign objects from entering the hair dryer.
**Result:** Loose hair strands pass through the honeycomb mesh and enter the air intake area.
**Expected vs. Actual:**
* **Expected:** The honeycomb mesh should safely block individual hair strands from being sucked into the fan blades or internal components.
* **Actual:** Several hair strands pass through the mesh and enter the air intake area. While the strands are thin, this demonstrates that the mesh does not provide adequate protection against small foreign objects.
**Reason for Failure:** The mesh openings are larger than necessary or the mesh density is insufficient to block thin strands of hair. This could lead to hair getting tangled in the fan or internal components, potentially causing damage or a fire hazard.

#### 3. TC-13: Casing Material Thermal Insulation Failure
**Objective:** Verify the thermal insulation performance of the ABS plastic casing.
**Result:** The handle of the hair dryer becomes uncomfortably hot after prolonged use at high heat settings.
**Expected vs. Actual:**
* **Expected:** The handle should remain cool to the touch, even during extended operation at high heat, thanks to the thermal insulation properties of the ABS plastic.
* **Actual:** After 10 minutes of continuous operation at High Heat (Position 2), the handle becomes noticeably hot. While not hot enough to cause an immediate burn, it is uncomfortable to hold and suggests poor heat dissipation.
**Reason for Failure:** The ABS plastic used for the casing does not provide adequate thermal insulation. Heat from the internal components is transferring to the handle, compromising user comfort and potentially indicating lower-quality plastic that may degrade over time with repeated exposure to heat.
...
- [x] **No PII or Sensitive Data Uploaded**: I confirm that I did not upload any Personally Identifiable Information (PII), confidential client data, or proprietary code to public AI tools.
- [x] **Human-in-the-Loop Verification**: I confirm that all AI-generated outputs (test cases, code, analysis) were independently reviewed, executed, and verified by me.
- [x] **Accountability for Hallucinations**: I understand that LLMs can hallucinate. I accept full responsibility for the accuracy and correctness of every word and line of code submitted in this report.
- [x] **Compliance with Course Policies**: I confirm that my use of AI aligns with the ethical guidelines and academic integrity policies outlined for this assignment.
- [x] **Disclosure of AI Use**: I have clearly documented all prompts and AI interactions in the `PromptLog.md` or equivalent report sections.
